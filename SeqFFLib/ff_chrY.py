...
def print_chrY_percentages(fraction_list, filename_list, gender):
    ...
    if gender == 'female':
        tmp_df.to_csv("/home/user/dir/female_1000_chrY_fraction.csv", index=False, header=False)
    elif gender == "adult_male":
        tmp_df.to_csv("/home/user/dir/male_6_chrY_fraction.csv", index=False, header=False)
    elif gender == "male_fetus":
        tmp_df.to_csv("/home/user/dir/male_fetus_1000_chrY_fraction.csv", index=False, header=False)
...
if __name__ == "__main__":
    #female_1000 = percentage_chrY("/home/user/dir/seqff/test/output/female/newtemp/*.newtemp", "female")
    #male_6 = percentage_chrY("/home/user/dir/seqff/test/output/adult_male/newtemp/*.newtemp", "adult_male")
    ...
    ff_list, filename_list = ff_chrY(female_1000, male_6, "/home/user/dir/seqff/test/output/male_20190114/newtemp/*.newtemp")

    ff_df = pd.DataFrame(data={'Dataname': filename_list, 'FetalFraction': ff_list})
    #save result as a csv file
    #ff_df.to_csv("/home/user/dir/seqff/test/output/male_20190114/ff_chrY.csv", index=False, header=False)
