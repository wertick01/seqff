...
class FeatureSelection():
    def __init__(self):
        ##location info
        self.female_path = glob.glob("/home/user/dir/seqff/test/output/female_notfiltered/normalizedbincount/*")
        self.male_path = glob.glob("/home/user/dir/seqff/test/output/male_notfiltered/normalizedbincount/*")
        self.supple_path = "/home/user/dir/seqff/test/supplementary-table2.csv"
        self.alluseablebins_path = "/home/user/dir/seqff/test/output/male_notfiltered/alluseablebins"
        self.male_ff_path = "/home/user/dir/seqff/test/output/ff_chrY.csv"
    ...
    def selection_with_elastic_net(self, alpha, l1_ratio, all_auto_array, male_ff_array, save=0):
        ...
        if save:
            with open("/home/user/dir/seqff/test/output/feature_selection/enet_coef.csv", 'w') as outfile:
                for i in regr.coef_:
